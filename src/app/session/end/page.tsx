        ...
        {!isEarlyExit && (
          <>
            ...
            {(dailyQuest || weeklyQuest) && (
              ...
              >
                <p className="text-gray-500 text-xs uppercase tracking-wide mb-2">Gˆrevler</p>
            ...
            {sessionData?.mode === 'duo' && (
              ...
              >
                ...
                <div className="flex justify-center gap-2 mb-3">
                  {[
                    { star: 1, emoji: 'üò´', label: 'Kˆt¸', trust: -5 },
                    { star: 2, emoji: 'üòê', label: 'Sorunlu', trust: -2 },
                    { star: 3, emoji: 'üôÇ', label: 'Iyi', trust: 0 },
                    { star: 4, emoji: 'üòä', label: '«ok iyi', trust: 2 },
                    { star: 5, emoji: 'ü§©', label: 'M¸kemmel', trust: 5 },
