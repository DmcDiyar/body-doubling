  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      if (profileError) {
        ...
        // Tablo yoksa veya trigger Áalismadiysa ‚Üí kullaniciyi manuel olustur
        if (profileError.code === '42P01' || !profile) {
          const { data: newProfile } = await supabase
            ...
            .single();
          if (newProfile) {
            // Yeni profil olustu ‚Üí onboarding'e yˆnlendir
        ...
        // avatar_id === 1 (default) VE name auto-generated ise ‚Üí onboarding gerekli
        ...
        // Profil yok ‚Äî trigger Áalismamis, manuel olustur
        const { data: newProfile } = await supabase
          .from('users')
          .upsert({
            id: authUser.id,
      ...
      // G¸nl¸k limit (maybeSingle ‚Äî satir yoksa null dˆner, 406 hata vermez)
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a2e] via-[#16213e] to-[#0f3460] px-4 py-8 pb-24">
      <div className="max-w-sm mx-auto">
        ...
        {(dailyQuest || weeklyQuest) && (
          ...
          >
            <div className="flex items-center justify-between">
              <p className="text-gray-500 text-xs uppercase tracking-wide">Gˆrevler</p>
              <p className="text-gray-600 text-xs">
                {hiddenCount}/{Object.keys(HIDDEN_QUEST_INFO).length} gizli gˆrev
              </p>
            </div>
        ...
        {activeMatch && (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">{activeMatch.state === 'active' ? '‚è±Ô∏è' : 'üîÑ'}</span>
              <div className="flex-1">
                <p className="text-white text-sm font-medium">
                  {activeMatch.state === 'active'
                    ? 'Devam eden seansin var!'
                    : 'Eslesmeye geri dˆnebilirsin!'}
                </p>
        ...
        <div className="mb-8 grid grid-cols-1 gap-3">
          ...
          >
            ...
            <div className="text-xs mt-1">
              {isRestricted
                ? 'Topluluk g¸venligi iÁin kisa bir ara.'
          ...
          >
            ...
            <div className="text-xs mt-1 text-gray-400">Sana ˆzel ayarlar</div>
          </button>
          ...
          >
            ...
            <div className="text-xs mt-1 text-gray-400">Nasil Áalistigini ˆgren</div>
          </button>
        </div>

        {!canStartSession && (
          <p className="text-gray-600 text-xs text-center mt-3">
            Yarin tekrar gel veya sinirsiz erisim iÁin premium&apos;a geÁ.
          </p>
        )}
