...
export function TrustChangeSummary({
    ...
    const getMessage = () => {
        switch (eventType) {
            case 'completed':
                return {
                    title: 'Seans Tamamlandi! ðŸŽ‰',
                    subtitle: 'Harika is çikardin.',
                    emoji: 'âœ¨',
                };
            case 'solo_completed':
                return {
    ...
    return (
        <div className="text-center">
            ...
            >
                <p className="text-gray-500 text-sm mb-4">Güven Puanin</p>
            ...
            {eventType === 'early_exit' && (
                ...
                >
                    <p>
                        <strong>Ipucu:</strong> Seanslari tamamlamak güven puanini artirir ve
