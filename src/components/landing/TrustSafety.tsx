...
const trustItems = [
    {
        ...
        description: 'Kimliğin asla paylaşılmaz. Tamamen anonim.',
        icon: (
    ...
    {
        title: 'Veri Toplamıyoruz',
        description: 'Kişisel veri saklamıyoruz. İzleme yok.',
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        description: 'Tüm bağlantılar şifreli. Güvende olduğunu bil.',
        icon: (
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-[#6B6B65] max-w-md mx-auto">
                        Güvende hissetmen için tasarlandı.
                    </p>
                </motion.div>
